...
def just_do_it():
    ...
    ap.add_argument('-a', '--area', required=False, type=float, default=89, help='total area of house')
    ap.add_argument('-f', '--firstRate', required=False, type=float, default=0.3, help='down payment ratio')
    ap.add_argument('-v', '--providentFund', required=False, type=float, default=1200000, help='provident fund loan')
    ap.add_argument('-d', '--providentFundRate', required=False, type=float, default=0.0325, help='provident fund rate')
    ap.add_argument('-l', '--lpr', required=False, type=float, default=0.0465, help='LPR')
