...
def just_do_it():
    ...
    ap.add_argument('-l', '--lpr', required=False, type=float, default=4.65, help='LPR')
    ap.add_argument('-y', '--years', required=False, type=int, default=25, help='years')
    ap.add_argument('-t', '--floatingRate', required=False, type=float, default=5, help='floating rate')
